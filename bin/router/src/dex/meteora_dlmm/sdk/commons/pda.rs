use crate::dex::meteora_dlmm::sdk::commons::seeds::{
...
pub fn derive_oracle_pda(lb_pair: Pubkey) -> (Pubkey, u8) {
    Pubkey::find_program_address(&[ORACLE, lb_pair.as_ref()],&crate::dex::meteora_dlmm::ID,)
}
...
pub fn derive_bin_array_bitmap_extension(lb_pair: Pubkey) -> (Pubkey, u8) {
    Pubkey::find_program_address(&[BIN_ARRAY_BITMAP_SEED, lb_pair.as_ref()],&crate::dex::meteora_dlmm::ID,)
}

pub fn derive_reserve_pda(token_mint: Pubkey, lb_pair: Pubkey) -> (Pubkey, u8) {
    Pubkey::find_program_address(&[lb_pair.as_ref(), token_mint.as_ref()], &crate::dex::meteora_dlmm::ID,)
}
...
pub fn derive_event_authority_pda() -> (Pubkey, u8) {
    Pubkey::find_program_address(&[b"__event_authority"], &crate::dex::meteora_dlmm::ID)
}

#[deprecated]
pub fn derive_preset_parameter_pda(bin_step: u16) -> (Pubkey, u8) {
    Pubkey::find_program_address(&[PRESET_PARAMETER, &bin_step.to_le_bytes()], &crate::dex::meteora_dlmm::ID)
}
...
pub fn derive_preset_parameter_pda_v2(index: u16) -> (Pubkey, u8) {
    Pubkey::find_program_address(&[PRESET_PARAMETER2, &index.to_le_bytes()], &crate::dex::meteora_dlmm::ID,)
}

pub fn derive_token_badge_pda(mint: Pubkey) -> (Pubkey, u8) {
    Pubkey::find_program_address(&[TOKEN_BADGE, mint.as_ref()], &crate::dex::meteora_dlmm::ID,)
}
