use crate::dex::meteora_dlmm::sdk::commons::constants::{BASIS_POINT_MAX, BIN_ARRAY_BITMAP_SIZE, FEE_PRECISION, MAX_BIN_ID, MAX_FEE_RATE, MIN_BIN_ID};
use crate::dex::meteora_dlmm::sdk::conversions::activation_type::ActivationTypeWrapper;
use crate::dex::meteora_dlmm::sdk::conversions::pair_type::PairTypeWrapper;
use crate::dex::meteora_dlmm::sdk::conversions::status::PairStatusWrapper;
...
impl LbPairExtension for LbPair {
    ...
    fn get_token_programs(&self) -> Result<[Pubkey; 2]> {
        ...
        // token_program_flag = 0 : TokenProgramFlags::TokenProgram
        // token_program_flag = 1 : TokenProgramFlags::TokenProgram2022
